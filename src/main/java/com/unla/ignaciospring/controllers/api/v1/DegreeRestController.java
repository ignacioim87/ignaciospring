package com.unla.ignaciospring.controllers.api.v1;
...
public class DegreeRestController {
	...
	public ResponseEntity<List<DegreeModel>> allDegrees(){
		...
		degrees.add(new DegreeModel(1,"Licenciatura en Sistemas","UNLa",2018));
		degrees.add(new DegreeModel(2,"Licenciatura en Turismo","UNLa",2018));
